...
const layers = [
  {
    ...
    itemKeys: ["stack.clients.0", "stack.clients.1", "stack.clients.2", "stack.clients.3"] as const,
    accent: "var(--accent)",
  },
  {
    titleKey: "stack.server" as const,
    itemKeys: ["stack.server.0", "stack.server.1", "stack.server.2", "stack.server.3"] as const,
    accent: "var(--accent-2)",
  },
  {
    titleKey: "stack.infra" as const,
    itemKeys: ["stack.infra.0", "stack.infra.1", "stack.infra.2", "stack.infra.3"] as const,
    accent: "#8dffb0",
  },
];
